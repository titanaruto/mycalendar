...
gulp.task('rsync', function() {
	return gulp.src('src/**')
		.pipe(rsync({
			root: 'src/',
			hostname: 'mycalendar.loc',
			destination: 'mycalendar.loc',
...
if (gulpversion == 3) {
	gulp.task('watch', ['styles', 'scripts', 'browser-sync'], function() {
		gulp.watch(['src/sass/**/*.scss'], ['styles']); // Наблюдение за sass файлами в папке sass в теме
		gulp.watch(['src/**/*.js', 'src/js/global.js'], ['scripts']); // Наблюдение за JS файлами js в теме
...
if (gulpversion == 4) {
	gulp.task('watch', function() {
		...
		gulp.watch(['src/**/*.js', 'src/js/global.js'], gulp.parallel('scripts')); // Наблюдение за JS файлами в папке js
		gulp.watch('src/**/*.php', browsersync.reload) // Наблюдение за sass файлами php в теме
	});
